...
(function($){
    ...
    $.chromatable = {
		...
		return this.each(function(){
				...
				$(".scrolling_outer").css({'position':'relative','width':options.width});
				$("#"+$uniqueID).css(
				...
				$("#"+$uniqueID).css('height', options.height);//alert(options.width)
				...
				$(this).before($(this).clone().attr("id", "scrolling_clone").addClass("_thead").css(
				...
				//alert("scroll: "+options.scrolling)
